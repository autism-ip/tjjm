...
"""
 * [INPUT]: 依赖 pytest 的 fixture 机制，依赖 torch 的张量构造，依赖 omegaconf 的 resolver 注册
 * [OUTPUT]: 对外提供 Hydra runtime resolver、session/device/fixture 等全局测试资源
 * [POS]: tests/ 的根配置，被所有测试模块共享
